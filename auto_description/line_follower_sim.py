...
class LineFollower(object):
    def __init__(self, rgb_to_track, colour_error_perc = 10.0,colour_cal=False, camera_topic="/autobot/camera/image_raw", cmd_vel_topic="auto/cmd_vel"):
    ...
    def move_robot(self, image_dim_y, image_dim_x, cx, cy, linear_vel_base = 0.01, angular_vel_base = 0.2):
        """
